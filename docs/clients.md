...
`OptiFine`*(高清修复)* 是一个 Mod，它可以提高游戏的帧率，减少游戏的卡顿和延迟，并提供更多的图像设置。不正确的使用此 Mod 很容易导致崩溃，不建议和多个优化 Mod 同时安装。
...
| 错误码 | 可能原因                          | 解决方法                                                     |
| ------ | --------------------------------- | ------------------------------------------------------------ |
| 1280   | OptiFine /  Mod 冲突 / OpenGL 版本错误 | 更换 OptiFine 版本、检查 Mod 冲突或尝试更新显卡驱动           |
| 1281   | Mods / 图像设置 / 显卡驱动 / 光影       | 尝试更新显卡驱动或检查 Mod 问题(如检查后无问题,则暂时无解)    |
| 1282   | 显卡驱动 /  Mod 冲突 / 着色器出错      | 更换游戏版本、更换 OptiFine 版本、检查 Mod 问题或更换显卡驱动 |
| 1283   | Mods                              | 更换光影或检查 Mods 问题                                       |
| 1284   | 显卡驱动 /  Mod 冲突 / 着色器出错      | 更换光影或检查 Mods 问题                                       |
| 1285   | 配置文件冲突 / 内存不足 /  Mod 冲突    | 给游戏分配更多的内存或尝试重新安装游戏                       |
